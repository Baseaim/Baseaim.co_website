...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${poppins.variable} ${workSans.variable} ${montserrat.variable} ${dmSerifDisplay.variable}`}>
      <head>
        <link rel="icon" href="/baseaim white.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="/baseaim white.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/baseaim white.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/baseaim white.png" />
